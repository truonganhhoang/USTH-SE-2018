...
public class EnemyControllerScorpion extends EnemyController implements Colliable {
    private EnemyControllerScorpion(int column, int row) {
        ...
        gameObject.setPowerLevel(500);
        gameObject.setHealth(500);
    }
    ...
    // Scorpion prioritize horizontal movement over vertical movement
    // Scorpion only move 1 step
    @Override
    ...
    public static void main(String[] args) {
        EnemyControllerScorpion controller = new EnemyControllerScorpion(1, 1);
        GameObject player = PlayerController.getInstance().getGameObject();
